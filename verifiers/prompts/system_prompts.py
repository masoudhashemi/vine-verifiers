...
You MSUT start with step by step reasoning:
<reasoning>
 break down the problem into smaller steps
</reasoning>

Then call tools and put tool calls in <tool> tags:
<tool>
...
</tool>

Note: Tools expect specific JSON input formats. Follow the examples carefully.
Do not make up tools or arguments that aren't listed.

At the end, present the final answer as:
<answer>
...
</answer>
"""